...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
        ...
        int mayorCantidad = numeroMonedas50;

        if (numeroMonedas100 > mayorCantidad) {
            mayorCantidad = numeroMonedas100;
            denominacionMasNumerosa = 100;
        }

        if (numeroMonedas200 > mayorCantidad) {
            mayorCantidad = numeroMonedas200;
            denominacionMasNumerosa = 200;
        }

        if (numeroMonedas500 > mayorCantidad) {
            mayorCantidad = numeroMonedas500;
            denominacionMasNumerosa = 500;
        }

        if (numeroMonedas1000 > mayorCantidad) {
            mayorCantidad = numeroMonedas1000;
    ...
    public boolean valiosa() {
        boolean esValiosa = numeroMonedas500 != 0 &&
                numeroMonedas1000 != 0
                && numeroMonedas50 == 0 && numeroMonedas100 == 0 && numeroMonedas200 == 0;
        return esValiosa;
    }
}
